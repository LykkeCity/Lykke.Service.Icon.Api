...
using Lykke.Job.Icon.Api.IncomingMessages;
using Lykke.RabbitMqBroker;
using Lykke.RabbitMqBroker.Subscriber;
using System;
using System.Threading.Tasks;

namespace Lykke.Job.Icon.Api.RabbitSubscribers
{
    public class MyRabbitSubscriber : IStartable, IStopable
    {
        ...
        public void Start()
        {
            ...
            var settings = RabbitMqSubscriptionSettings
                .CreateForSubscriber(_connectionString, _exchangeName, "icon.apijob");
